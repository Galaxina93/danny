    ...
    <x-forms.form submit="saveOrUpdate()" :grid="true">
        ...
        @foreach($this->getModelFields('edit') as $attribute)
            ...
            @else
                ...
                @include('global.livewire.crud.main.partials.field')
        ...
        <div class="flex justify-content-around mt-4 col-span-full">
            ...
            <x-forms.button wireClick="toggleVisibility('edit', false)" title="Abbrechen" category="secondary" type="button" class="ml-4"/>
        </div>
