<div>
    <div class="relative" x-data="{ open: false }">
        <button @click="open = !open" type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
            ...
            @if($user && $user->profile->photo_path != null)
        ...
        <div x-show="open" @click.away="open = false"
            ...
            @if($user)
                <a href="{{ route($guard . '.dashboard') }}" class="profile-dropdown-nav-item" role="menuitem" tabindex="-1" id="user-menu-item-0">
                    Dashboard
                </a>
                <div class="border-t border-gray-100"></div>
                <a href="{{ route($guard . '.profile') }}" class="profile-dropdown-nav-item" role="menuitem" tabindex="-1" id="user-menu-item-0">
                    Profil
                </a>
                <div class="border-t border-gray-100"></div>
                <a wire:click="logout" class="profile-dropdown-nav-item" role="menuitem" tabindex="-1" id="user-menu-item-0">
                    Logout
                </a>
            @else
                <a href="/login" class="profile-dropdown-nav-item" role="menuitem" tabindex="-1" id="user-menu-item-1">Login</a>
            @endif
