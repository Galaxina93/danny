                        ...
                        <div class="lg:max-w-lg">
                            ...
                            <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                <div class="relative pl-9">
                                    ...
                                    <dd class="inline">Wir prüfen Ihre PV-Anlage und führen alle notwendigen Wartungsarbeiten durch, um die Funktionsfähigkeit Ihrer Anlage zu gewährleisten.</dd>
                                </div>
                                ...
                                <div class="relative pl-9">
                                    ...
                                    <dd class="inline">
                                        ...
                                        Als Fachpartner diverser Solarfirmen sind wir mit modernen und speziellen Mess- und Prüfgeräten ausgestattet, um Störungen und Fehler zu suchen, einzugrenzen und zu beheben.
                ...
                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    ...
                    <div class="lg:pl-8 lg:pt-4">
                        <div class="lg:max-w-lg">
                            ...
                            <h2 class="text-base font-semibold leading-7 text-primary">
                                Regelmäßige Überprüfungen sind unverzichtbar!
                            </h2>
                            ...
                            <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                ...
                                <div class="relative pl-9">
                                    <dt class="inline font-semibold text-gray-900">
                                        <svg class="absolute left-1 top-1 h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none"
